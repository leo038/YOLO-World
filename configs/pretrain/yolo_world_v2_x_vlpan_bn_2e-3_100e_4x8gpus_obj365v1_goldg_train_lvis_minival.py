...
coco_val_dataset = dict(
    ...
    dataset=dict(type='YOLOv5LVISV1Dataset',
                 data_root='/data/joyiot/leo/codes/YOLO-World/demo/data/coco/',
                 test_mode=True,
...
val_evaluator = dict(type='mmdet.LVISMetric',
                     ann_file='/data/joyiot/leo/codes/YOLO-World/demo/data/coco/lvis/lvis_v1_minival_inserted_image_name.json',
                     metric='bbox')
